...
execute positioned 0 0 0 unless entity @e[distance=..17] at @s run function missilewars:custom_missile/check_name_save_missile

execute positioned 0 0 0 if entity @e[distance=..17] at @s run function missilewars:custom_missile/check_id_save_missile
