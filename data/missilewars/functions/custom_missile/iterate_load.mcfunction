...
execute as @e[tag=mover] at @s if score temp3 Constants matches 0 run tp ~1 ~ 23.5
...
execute as @e[tag=mover] at @s if score temp3 Constants matches 0 if score rows_completed Constants matches 0 run tp 37.5 ~1 23.5
...
execute if score temp2 Constants <= Iterations Constants run function missilewars:custom_missile/iterate_load