...
execute store result score NumBook Constants run clear @s written_book{title:How-To} 0
clear @s
execute if score NumBook Constants matches 1 run function missilewars:start/give_book
