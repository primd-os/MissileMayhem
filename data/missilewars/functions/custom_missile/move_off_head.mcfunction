...
data modify storage missilewars:temp offhand[{id:"minecraft:writable_book",Slot:0b}].tag.pages append from storage rx:io playerdb.player.data.primd.mm.custom
