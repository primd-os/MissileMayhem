...
execute store result score NumBook Variables run clear @s written_book{title:How-To} 0
clear @s
execute if score NumBook Variables matches 1 run function missilewars:start/give_book
