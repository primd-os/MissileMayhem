...
data modify storage missilewars:temp offhand[{id:"minecraft:writable_book",Slot:0b}].tag.pages insert 0 from storage rx.playerdb:io player.data.primd.mm.custom
