...
execute at @e[type=area_effect_cloud,tag=CustomMissileArea,sort=nearest,limit=1] run setblock ^ ^5 ^6 minecraft:structure_block[mode=save]{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,author:"kcor_noved",rotation:"NONE",posX:3,mode:"SAVE",posY:1,sizeX:3,posZ:-8,integrity:1.0f,showair:0b,sizeY:3,sizeZ:17}
...
execute at @e[type=area_effect_cloud,tag=CustomMissileArea,sort=nearest,limit=1] run fill ^-10 ^6 ^8 ^8 ^10 ^12 minecraft:structure_void replace air
execute at @e[type=area_effect_cloud,tag=CustomMissileArea,sort=nearest,limit=1] run fill ^-10 ^6 ^8 ^8 ^10 ^12 minecraft:magenta_wool replace white_wool
execute at @e[type=area_effect_cloud,tag=CustomMissileArea,sort=nearest,limit=1] run fill ^-10 ^6 ^8 ^8 ^10 ^12 minecraft:magenta_stained_glass replace white_stained_glass
...
execute at @e[type=area_effect_cloud,tag=CustomMissileArea,sort=nearest,limit=1] run fill ^-10 ^6 ^8 ^8 ^10 ^12 air replace minecraft:structure_void
