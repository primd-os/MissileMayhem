...
execute as @s[team=Spectator] as @e[tag=mover] at @s if score temp Constants matches 1 run setblock ~ ~ ~ white_wool
...
execute as @s[team=Spectator] as @e[tag=mover] at @s if score temp Constants matches 2 run setblock ~ ~ ~ white_stained_glass
