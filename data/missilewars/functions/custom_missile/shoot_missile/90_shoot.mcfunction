...
execute as @e[tag=mover] at @s if score temp3 Constants matches 0 run tp ~18 ~ ~-1
...
execute if score temp2 Constants <= Iterations Constants run function missilewars:custom_missile/shoot_missile/90_shoot