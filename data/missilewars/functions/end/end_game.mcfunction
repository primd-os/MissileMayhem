...
execute if score @e[tag=BlueBase,x=0,limit=1] BlueWin matches 1 at @e[tag=GreenBase,x=0] positioned ^-20 ^ ^ run fill ~ 0 ~ ^40 ^-4 ^ minecraft:air replace green_terracotta
execute if score @e[tag=BlueBase,x=0,limit=1] GreenWin matches 1 at @e[tag=BlueBase,x=0] positioned ^-20 ^ ^ run fill ~ 0 ~ ^40 ^-4 ^ minecraft:air replace blue_terracotta
