...
execute if score @e[tag=BlueBase,x=0,limit=1] GreenWin matches 1 at @e[tag=BlueBase,x=0] run playsound minecraft:entity.generic.explode master @a 0 25 ~ 100
execute if score @e[tag=BlueBase,x=0,limit=1] BlueWin matches 1 at @e[tag=GreenBase,x=0] run playsound minecraft:entity.generic.explode master @a 0 25 ~ 100
