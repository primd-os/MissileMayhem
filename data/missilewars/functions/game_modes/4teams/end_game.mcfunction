...
execute if entity @s[scores={m.PreBlackWin=1}] run playsound minecraft:ui.toast.challenge_complete block @a[x=0,team=Purple] ~ ~ ~ 1 2 1
...
execute if entity @s[scores={m.PreBlackWin=1}] if entity @a[x=0,team=!Spectator,team=!Purple] run advancement grant @a[x=0,team=Purple] only missilewars:win_game
...
execute if entity @s[scores={m.PreBlackWin=1}] if entity @e[type=marker,tag=GameMarker,x=0,scores={m.Timer=-900..}] if entity @a[x=0,team=!Spectator,team=!Purple] run advancement grant @a[x=0,team=Purple] only missilewars:2gud4u
...
execute if entity @s[scores={m.PreBlackWin=1}] if entity @e[type=marker,tag=GameMarker,x=0,scores={m.Timer=-200..}] if entity @a[x=0,team=!Spectator,team=!Purple] run advancement grant @a[x=0,team=Purple] only missilewars:manipulation
