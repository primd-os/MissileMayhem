...
execute as @a[team=Red,x=0] run scoreboard players operation @e[type=area_effect_cloud,tag=BlueBase,x=0,limit=1] RedMembers += @s points
execute as @a[team=Black,x=0] run scoreboard players operation @e[type=area_effect_cloud,tag=BlueBase,x=0,limit=1] BlackMembers += @s points
