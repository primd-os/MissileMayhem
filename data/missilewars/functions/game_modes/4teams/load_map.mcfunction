...
execute at @e[type=area_effect_cloud,tag=RedBase,x=0] if score Map m.Variables matches 2..5 run function missilewars:maps/red/basic_map
execute at @e[type=area_effect_cloud,tag=BlackBase,x=0] if score Map m.Variables matches 2..5 run function missilewars:maps/black/basic_map
...
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 3 run fill ^-25 ^-20 ^23 ^25 ^-20 ^30 white_stained_glass
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 3 run fill ^-25 ^-40 ^23 ^25 ^-40 ^32 white_stained_glass

execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 4 run fill ^-15 ^ ^22 ^15 ^50 ^17 minecraft:air
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 4 run fill ^-5 ^ ^17 ^5 ^50 ^11 minecraft:air
