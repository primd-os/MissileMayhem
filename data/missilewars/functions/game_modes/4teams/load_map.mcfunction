...
execute at @e[type=area_effect_cloud,tag=RedBase,x=0] if score Map m.Variables matches 0 run function missilewars:maps/red/basic_map
execute at @e[type=area_effect_cloud,tag=BlackBase,x=0] if score Map m.Variables matches 0 run function missilewars:maps/black/basic_map
...
execute at @e[type=area_effect_cloud,tag=RedBase,x=0] if score Map m.Variables matches 3..7 run function missilewars:maps/red/basic_map
execute at @e[type=area_effect_cloud,tag=BlackBase,x=0] if score Map m.Variables matches 3..7 run function missilewars:maps/black/basic_map
execute if score Map m.Variables matches 3 run fill -25 0 -2 25 100 2 white_stained_glass
execute if score Map m.Variables matches 3 run fill -2 0 -25 2 100 25 white_stained_glass
...
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 5 run fill ^-15 ^ ^22 ^15 ^50 ^17 minecraft:air
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map m.Variables matches 5 run fill ^-5 ^ ^17 ^5 ^50 ^11 minecraft:air
...
execute at @e[type=area_effect_cloud,tag=RedBase,x=0] if score Map m.Variables matches 6 run fill ~-9 ~ -2 0 ~ 2 white_stained_glass
execute at @e[type=area_effect_cloud,tag=BlackBase,x=0] if score Map m.Variables matches 6 run fill ~9 ~ -2 0 ~ 2 white_stained_glass
