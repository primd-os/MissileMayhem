...
execute if score @e[type=area_effect_cloud,tag=GameMarker,x=0,limit=1] m.GameState matches 0 run scoreboard players enable @a[x=0] JoinRed
execute unless score @e[type=area_effect_cloud,tag=GameMarker,x=0,limit=1] m.GameState matches 0 run scoreboard players reset @a[x=0] JoinRed
execute if score @e[type=area_effect_cloud,tag=GameMarker,x=0,limit=1] m.GameState matches 0 run scoreboard players enable @a[x=0] JoinBlack
execute unless score @e[type=area_effect_cloud,tag=GameMarker,x=0,limit=1] m.GameState matches 0 run scoreboard players reset @a[x=0] JoinBlack
