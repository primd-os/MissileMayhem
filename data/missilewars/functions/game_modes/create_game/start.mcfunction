...
tellraw @s [{"text": "    King of the Hill","clickEvent": {"action": "run_command", "value": "/trigger CreateGame set 2"}}]
tellraw @s [{"text": "    Capture the Flag","clickEvent": {"action": "run_command", "value": "/trigger CreateGame set 3"}}]
