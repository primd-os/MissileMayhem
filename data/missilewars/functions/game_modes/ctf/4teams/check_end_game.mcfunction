execute unless score @s m.GreenLoss matches 1 if score @s m.GreenScore matches 0 unless entity @a[tag=carrier,team=m.Green,x=0] run scoreboard players set @s m.PreGreenLoss 1
execute unless score @s m.BlueLoss matches 1 if score @s m.BlueScore matches 0 unless entity @a[tag=carrier,team=m.Blue,x=0] run scoreboard players set @s m.PreBlueLoss 1
execute unless score @s m.RedLoss matches 1 if score @s m.RedScore matches 0 unless entity @a[tag=carrier,team=m.Red,x=0] run scoreboard players set @s m.PreRedLoss 1
execute unless score @s m.PurpleLoss matches 1 if score @s m.PurpleScore matches 0 unless entity @a[tag=carrier,team=m.Purple,x=0] run scoreboard players set @s m.PrePurpleLoss 1
...
execute if score @s m.PreGreenWin matches 1 if entity @e[type=marker,tag=GreenBase,tag=m.PerfectCTFPossible,x=0] run advancement grant @a[x=0,team=m.Green] only missilewars:perfect_ctf
execute if score @s m.PreBlueWin matches 1 if entity @e[type=marker,tag=BlueBase,tag=m.PerfectCTFPossible,x=0] run advancement grant @a[x=0,team=m.Blue] only missilewars:perfect_ctf
execute if score @s m.PreRedWin matches 1 if entity @e[type=marker,tag=RedBase,tag=m.PerfectCTFPossible,x=0] run advancement grant @a[x=0,team=m.Red] only missilewars:perfect_ctf
execute if score @s m.PrePurpleWin matches 1 if entity @e[type=marker,tag=PurpleBase,tag=m.PerfectCTFPossible,x=0] run advancement grant @a[x=0,team=m.Purple] only missilewars:perfect_ctf
