...
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0,scores={m.Timer=0}] run function missilewars:game_modes/ctf/4teams/load_map
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0,scores={m.Timer=0}] unless entity @a[team=Blue,x=0] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] BluePoints 0
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0,scores={m.Timer=0}] unless entity @a[team=Green,x=0] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] GreenPoints 0
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0,scores={m.Timer=0}] unless entity @a[team=Red,x=0] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] RedPoints 0
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0,scores={m.Timer=0}] unless entity @a[team=Black,x=0] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] BlackPoints 0
