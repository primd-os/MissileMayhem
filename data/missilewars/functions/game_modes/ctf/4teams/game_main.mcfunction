...
execute if entity @s[scores={m.Timer=0}] unless entity @a[x=0,team=!m.Spectator] run function missilewars:game_modes/ctf/2teams/reset_game
...
execute if score @s m.BlueScore matches 0 at @e[type=marker,tag=BlueBase,x=0] run particle minecraft:block_marker barrier ~ ~80 ~ 5 5 5 1 5 force @a[x=0]
execute if score @s m.GreenScore matches 0 at @e[type=marker,tag=GreenBase,x=0] run particle minecraft:block_marker barrier ~ ~80 ~ 5 5 5 1 5 force @a[x=0]
execute if score @s m.RedScore matches 0 at @e[type=marker,tag=RedBase] run particle minecraft:block_marker barrier ~ ~80 ~ 5 5 5 1 5 force @a[x=0]
execute if score @s m.PurpleScore matches 0 at @e[type=marker,tag=PurpleBase,x=0] run particle minecraft:block_marker barrier ~ ~80 ~ 5 5 5 1 5 force @a[x=0]
