...
scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.RedScore 0
scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.BlackScore 0
execute if entity @a[x=0,team=Green] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.GreenScore 1
execute if entity @a[x=0,team=Blue] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.BlueScore 1
execute if entity @a[x=0,team=Red] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.RedScore 1
execute if entity @a[x=0,team=Black] run scoreboard players set @e[type=area_effect_cloud,tag=BlueBase,x=0] m.BlackScore 1
