...
execute if entity @a[x=0,team=Black] at @e[type=marker,tag=BlackBase,x=0] run summon minecraft:marker ^ ^-19 ^-6 {Tags: ["Flag"]}
...
execute if entity @a[x=0,team=Black] run scoreboard players set @e[type=marker,tag=GameMarker,x=0] m.BlackScore 1