...
execute as @s[team=Black,tag=carrier] at @e[type=area_effect_cloud,tag=BlackBase,x=0] positioned ~ ~-20 ~-25 positioned ^ ^ ^-6 positioned ~-1 ~ ~-1 as @s[dx=2,dy=1,dz=50] run tag @s add success
execute as @s[team=Red,tag=carrier] at @e[type=area_effect_cloud,tag=RedBase,x=0] positioned ~ ~-20 ~-25 positioned ^ ^ ^-6 positioned ~-1 ~ ~-1 as @s[dx=2,dy=1,dz=50] run tag @s add success
execute as @s[team=Blue,tag=carrier] at @e[type=area_effect_cloud,tag=BlueBase,x=0] positioned ~-25 ~-20 ~ positioned ^ ^ ^-6 positioned ~-1 ~ ~-1 as @s[dx=50,dy=1,dz=2] run tag @s add success
execute as @s[team=Green,tag=carrier] at @e[type=area_effect_cloud,tag=GreenBase,x=0] positioned ~-25 ~-20 ~ positioned ^ ^ ^-6 positioned ~-1 ~ ~-1 as @s[dx=50,dy=1,dz=2] run tag @s add success
...
execute as @s[tag=!carrier,team=Black] at @s as @e[type=area_effect_cloud,tag=Base,sort=nearest,limit=1] as @s[tag=!BlackBase] as @a[distance=..0.01] as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=!taken] run tag @s add claiming
execute as @s[tag=!carrier,team=Blue] at @s as @e[type=area_effect_cloud,tag=Base,sort=nearest,limit=1] as @s[tag=!BlueBase] as @a[distance=..0.01] as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=!taken] run tag @s add claiming
execute as @s[tag=!carrier,team=Red] at @s as @e[type=area_effect_cloud,tag=Base,sort=nearest,limit=1] as @s[tag=!RedBase] as @a[distance=..0.01] as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=!taken] run tag @s add claiming
execute as @s[tag=!carrier,team=Green] at @s as @e[type=area_effect_cloud,tag=Base,sort=nearest,limit=1] as @s[tag=!GreenBase] as @a[distance=..0.01] as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=!taken] run tag @s add claiming
execute as @s[tag=!carrier] at @s if entity @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=claiming] run tellraw @a[x=0] [{"selector": "@s"},{"text": " has taken a Flag!"}]
execute as @s[tag=!carrier] at @s as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=claiming] run tag @s add taken
execute as @s[tag=!carrier] at @s if entity @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=claiming] run scoreboard players operation @e[type=area_effect_cloud,sort=nearest,tag=Flag,tag=claiming,limit=1] UUID1 = @s UUID1
execute as @s[tag=!carrier] at @s if entity @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=claiming] run tag @s add carrier
execute at @s as @e[type=area_effect_cloud,distance=..1,tag=Flag,tag=claiming] run tag @s remove claiming
