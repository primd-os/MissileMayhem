execute unless entity @e[type=marker,tag=m.FFABase] at @e[type=marker,tag=Flag,tag=!taken] run fill ~-1 ~-1 ~-1 ~1 ~-1 ~1 obsidian
execute if entity @e[type=marker,tag=m.FFABase] at @e[type=marker,tag=Flag,tag=!taken] run fill ~ ~-1 ~ ~ ~-1 ~ obsidian
execute unless entity @e[type=marker,tag=m.FFABase] at @e[type=marker,tag=Flag,tag=!taken] run fill ~-1 ~ ~-1 ~1 ~2 ~1 air
execute if entity @e[type=marker,tag=m.FFABase] at @e[type=marker,tag=Flag,tag=!taken] run fill ~ ~ ~ ~ ~2 ~ air
execute at @e[type=marker,tag=Flag,tag=!taken] as @e[type=marker,tag=m.FFABase,sort=nearest,limit=1] run setblock ~ ~ ~ white_banner[rotation=0]
...
execute at @e[type=marker,tag=Flag,tag=!taken] positioned ~ ~30 ~ as @e[type=marker,tag=m.FFABase,sort=nearest,limit=1] run setblock ~ ~ ~ white_banner[rotation=0]
