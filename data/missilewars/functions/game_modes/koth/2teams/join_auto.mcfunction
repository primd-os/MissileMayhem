...
execute unless entity @e[tag=BlueBase,x=0] run function missilewars:game_modes/koth/2teams/init_arena
execute if entity @e[tag=BlueBase,x=0] unless score @e[tag=BlueBase,x=0,limit=1] Game = @a[tag=ActivePlayer,x=0,limit=1] Game run function missilewars:game_modes/koth/2teams/init_arena
