...
execute if entity @s[scores={PreGreenWin=1}] run advancement grant @a[x=0,team=Green] only missilewars:win_game
execute if entity @s[scores={PreBlueWin=1}] run advancement grant @a[x=0,team=Blue] only missilewars:win_game
execute if entity @s[scores={PreRedWin=1}] run advancement grant @a[x=0,team=Red] only missilewars:win_game
execute if entity @s[scores={PreBlackWin=1}] run advancement grant @a[x=0,team=Black] only missilewars:win_game
