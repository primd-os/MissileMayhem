...
execute unless score @s RedWin matches 1 if score @s GreenScore >= WinningScore Constants run scoreboard players set @s PreRedWin 1
execute unless score @s BlackWin matches 1 if score @s GreenScore >= WinningScore Constants run scoreboard players set @s PreBlackWin 1
