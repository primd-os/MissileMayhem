...
execute as @a[team=Blue,x=0] run scoreboard players add WinningScore m.Variables 1000
...
scoreboard players operation WinningScore m.Variables = WinningScore m.Constants
execute as @a[team=Green,x=0] run scoreboard players add WinningScore m.Variables 1000
...
scoreboard players operation WinningScore m.Variables = WinningScore m.Constants
execute as @a[team=Red,x=0] run scoreboard players add WinningScore m.Variables 1000
...
scoreboard players operation WinningScore m.Variables = WinningScore m.Constants
execute as @a[team=Purple,x=0] run scoreboard players add WinningScore m.Variables 1000
