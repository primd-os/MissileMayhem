...
execute positioned -2.5 15 -2.5 if entity @a[x=0,tag=Claiming,team=Blue] run scoreboard players add @e[type=marker,tag=GameMarker,x=0] m.BlueScore 1
execute positioned -2.5 15 -2.5 if entity @a[x=0,tag=Claiming,team=Green] run scoreboard players add @e[type=marker,tag=GameMarker,x=0] m.GreenScore 1
execute positioned -2.5 15 -2.5 if entity @a[x=0,tag=Claiming,team=Red] run scoreboard players add @e[type=marker,tag=GameMarker,x=0] m.RedScore 1
execute positioned -2.5 15 -2.5 if entity @a[x=0,tag=Claiming,team=Black] run scoreboard players add @e[type=marker,tag=GameMarker,x=0] m.BlackScore 1
