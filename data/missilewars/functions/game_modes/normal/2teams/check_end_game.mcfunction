...
execute if score @e[type=area_effect_cloud,tag=BlueBase,x=0,limit=1] m.GameState matches 2 if score @s m.BlueWin matches 1 if score @s m.GreenWin matches 1 run function missilewars:end/tie_game
