...
execute if entity @e[type=area_effect_cloud,tag=BlueBase,x=0] unless score @e[type=area_effect_cloud,tag=BlueBase,x=0,limit=1] Game = @a[tag=ActivePlayer,x=0,limit=1] Game run function missilewars:game_modes/normal/2teams/init_arena
