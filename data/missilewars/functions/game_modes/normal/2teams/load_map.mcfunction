...
execute at @e[type=area_effect_cloud,tag=BlueBase,x=0] if score Map Variables matches 1..2 run function missilewars:maps/blue/map
execute at @e[type=area_effect_cloud,tag=GreenBase,x=0] if score Map Variables matches 1..2 run function missilewars:maps/green/map
...
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map Variables matches 5 positioned ^-15 ^ ^17 run fill ~ 0 ~ ^30 ^ ^5 minecraft:air
execute at @e[type=area_effect_cloud,tag=Base,x=0] if score Map Variables matches 5 positioned ^-5 ^ ^11 run fill ~ 0 ~ ^10 ^ ^5 minecraft:air
