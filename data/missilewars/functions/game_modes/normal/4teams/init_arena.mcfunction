...
summon minecraft:marker -75 50 0 {Tags: ["Base","BlackBase"]}
...
scoreboard players set @e[type=marker,tag=GameMarker,x=0] m.BlackLoss 0
execute as @e[type=marker,tag=BlueBase,x=0] at @s run tp @s ~ ~ ~ ~180 ~
execute as @e[type=marker,tag=RedBase,x=0] at @s run tp @s ~ ~ ~ ~90 ~
execute as @e[type=marker,tag=BlackBase,x=0] at @s run tp @s ~ ~ ~ ~270 ~
