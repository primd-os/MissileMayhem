execute unless score @s m.BlueWin matches 1 if entity @a[team=Blue,z=50,dz=50,x=-200,dx=400,y=0,dy=200,tag=m.GotRace] run scoreboard players set @s m.PreBlueWin 1
execute unless score @s m.GreenWin matches 1 if entity @a[team=Green,z=50,dz=50,x=-200,dx=400,y=0,dy=200,tag=m.GotRace] run scoreboard players set @s m.PreGreenWin 1
execute unless score @s m.RedWin matches 1 if entity @a[team=Red,z=50,dz=50,x=-200,dx=400,y=0,dy=200,tag=m.GotRace] run scoreboard players set @s m.PreRedWin 1
execute unless score @s m.PurpleWin matches 1 if entity @a[team=Purple,z=50,dz=50,x=-200,dx=400,y=0,dy=200,tag=m.GotRace] run scoreboard players set @s m.PrePurpleWin 1
