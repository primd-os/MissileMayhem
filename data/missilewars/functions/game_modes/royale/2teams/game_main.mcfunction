...
execute if entity @s[scores={m.Timer=0}] run function missilewars:game_modes/royale/2teams/init_arena
execute if entity @s[scores={m.Timer=0}] run function missilewars:game_modes/royale/load_map

execute as @a[scores={m.Game=1..},x=0] at @s run function missilewars:game_modes/royale/2teams/running_main
function missilewars:item_managers/run_items

execute if score @s m.GameState matches 1..2 run function missilewars:game_modes/royale/2teams/check_end_game
execute as @s[scores={m.GameState=2..,m.EndTimer=0}] at @s run function missilewars:game_modes/royale/2teams/reset_game
