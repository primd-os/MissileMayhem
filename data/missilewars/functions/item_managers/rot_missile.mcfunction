execute store result score Temp Variables run data get block ~ ~ ~ posX 1
...
execute if entity @s[scores={DirecToPlace=1}] store result block ~ ~ ~ posZ int -1 run scoreboard players get Temp Variables
...
execute if entity @s[scores={DirecToPlace=3}] store result block ~ ~ ~ posZ int 1 run scoreboard players get Temp Variables
