...
execute as @e[x=0,type=minecraft:snowball,scores={snowballTime=20}, tag=Shield] at @s if predicate missilewars:shield_inbounds unless score @s DirecToPlace matches 1 unless score @s DirecToPlace matches 3 run setblock ~ ~ ~ structure_block{rotation: "CLOCKWISE_90", posX:3, posY:-3, posZ:0, mode:"LOAD"}
execute as @e[x=0,type=minecraft:snowball,scores={snowballTime=20}, tag=Shield] at @s if predicate missilewars:shield_inbounds unless score @s DirecToPlace matches 0 unless score @s DirecToPlace matches 2 run setblock ~ ~ ~ structure_block{posX:0, posY:-3, posZ:-3, mode:"LOAD"}
execute as @e[x=0,type=minecraft:snowball,scores={snowballTime=20}, tag=Shield] at @s unless entity @e[x=0,tag=BlueBase] unless score @s DirecToPlace matches 1 unless score @s DirecToPlace matches 3 run setblock ~ ~ ~ structure_block{rotation: "CLOCKWISE_90", posX:3, posY:-3, posZ:0, mode:"LOAD"}
execute as @e[x=0,type=minecraft:snowball,scores={snowballTime=20}, tag=Shield] at @s unless entity @e[x=0,tag=BlueBase] unless score @s DirecToPlace matches 0 unless score @s DirecToPlace matches 2 run setblock ~ ~ ~ structure_block{posX:0, posY:-3, posZ:-3, mode:"LOAD"}
