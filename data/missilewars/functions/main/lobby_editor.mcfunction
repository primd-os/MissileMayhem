...
execute if score @s Items matches 0 run give @s white_wool{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s white_stained_glass 0
execute if score @s Items matches 0 run give @s white_stained_glass{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s redstone_block 0
execute if score @s Items matches 0 run give @s redstone_block{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s observer 0
execute if score @s Items matches 0 run give @s observer{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s piston 0
execute if score @s Items matches 0 run give @s piston{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s sticky_piston 0
execute if score @s Items matches 0 run give @s sticky_piston{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
execute store result score @s Items run clear @s slime_block 0
execute if score @s Items matches 0 run give @s slime_block{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
...
execute if score @s Items matches 0 run give @s gray_glazed_terracotta{CanPlaceOn:["#missilewars:custom_blocks"],CanDestroy:["#missilewars:custom_blocks"]} 64
