...
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~-9 ~8 ~9 ~8 minecraft:air replace tnt
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~12 ~6 ~-9 ~12 ~9 ~9 minecraft:air replace tnt
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~-9 ~12 ~9 ~-9 minecraft:air replace tnt
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~9 ~12 ~9 ~9 minecraft:air replace tnt
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~9 ~-9 ~12 ~9 ~9 minecraft:air replace tnt
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~-9 ~8 ~9 ~8 minecraft:air replace moving_piston{blockState:{Name:"minecraft:tnt"}}
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~12 ~6 ~-9 ~12 ~9 ~9 minecraft:air replace moving_piston{blockState:{Name:"minecraft:tnt"}}
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~-9 ~12 ~9 ~-9 minecraft:air replace moving_piston{blockState:{Name:"minecraft:tnt"}}
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~6 ~9 ~12 ~9 ~9 minecraft:air replace moving_piston{blockState:{Name:"minecraft:tnt"}}
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt
execute at @s as @e[tag=CustomMissileArea,sort=nearest,limit=1] at @s store result score tnt Constants run fill ~8 ~9 ~-9 ~12 ~9 ~9 minecraft:air replace moving_piston{blockState:{Name:"minecraft:tnt"}}
execute at @s run scoreboard players operation @e[tag=CustomMissileArea,sort=nearest,limit=1] tntCount -= tnt Constants
function missilewars:custom_missile/give_tnt