...
execute as @a[tag=Editor] store result score @s Items run clear @s white_stained_glass 0
execute as @a[tag=Editor] if score @s Items matches 0..63 run give @s white_stained_glass 1
