...
execute as @e[tag=BlueBase,x=0] run scoreboard players operation @s TimerSecs /= TPS Constants
execute as @e[tag=BlueBase,x=0] run scoreboard players operation @s TimerTick %= TPS Constants
