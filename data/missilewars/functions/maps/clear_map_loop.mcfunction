...
execute as @e[type=area_effect_cloud,tag=clearMap,scores={m.clearY=0..127}] at @s run function missilewars:maps/slow_clear_map_loop
kill @e[type=area_effect_cloud,tag=clearMap,scores={m.clearY=128..}]