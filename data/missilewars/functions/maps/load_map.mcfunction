...
execute as @e[tag=BlueBase,x=0] at @s if score Map Constants matches 7 run tp ~50 ~ ~
execute as @e[tag=GreenBase,x=0] at @s if score Map Constants matches 7 run tp ~-50 ~ ~
...
execute at @e[tag=BlueBase,x=0] if score Map Constants matches 3 run function missilewars:maps/blue/basic_map
execute at @e[tag=GreenBase,x=0] if score Map Constants matches 3 run function missilewars:maps/green/basic_map
execute at @e[tag=BlueBase,x=0] if score Map Constants matches 3 run fill ~-25 0 -2 ~25 50 2 white_stained_glass

execute at @e[tag=BlueBase,x=0] if score Map Constants matches 4 run function missilewars:maps/blue/basic_map
execute at @e[tag=GreenBase,x=0] if score Map Constants matches 4 run function missilewars:maps/green/basic_map
...
execute at @e[tag=BlueBase,x=0] if score Map Constants matches 5 run function missilewars:maps/blue/basic_map
execute at @e[tag=GreenBase,x=0] if score Map Constants matches 5 run function missilewars:maps/green/basic_map
...
execute at @e[tag=BlueBase,x=0] if score Map Constants matches 6 run function missilewars:maps/blue/basic_map
execute at @e[tag=GreenBase,x=0] if score Map Constants matches 6 run function missilewars:maps/green/basic_map
...
execute at @e[tag=BlueBase,x=0] if score Map Constants matches 7 run function missilewars:maps/blue/basic_map
execute at @e[tag=GreenBase,x=0] if score Map Constants matches 7 run function missilewars:maps/green/basic_map