...
scoreboard players set @e[type=area_effect_cloud,tag=clearMap,x=0] m.clearX -112
scoreboard players set @e[type=area_effect_cloud,tag=clearMap,x=0] m.clearY 0
