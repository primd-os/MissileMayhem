execute if score missile_time m.Variables matches 0 as @e[type=area_effect_cloud,tag=GameMarker] if score @s m.GameState matches 1 at @s run function missilewars:new_missile/new_missile
