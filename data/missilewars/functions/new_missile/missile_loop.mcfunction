execute if score missile_time Variables matches 0 as @e[tag=BlueBase] if score @s GameState matches 1 at @s run function missilewars:new_missile/new_missile
