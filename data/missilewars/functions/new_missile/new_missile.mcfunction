...
execute store result score QueueSize m.Variables run data get storage missilewars:queue queue
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:creeper_spawn_egg"}]}] store result score TomahawkQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:wolf_spawn_egg"}]}] store result score JuggernautQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:ocelot_spawn_egg"}]}] store result score LightningQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:witch_spawn_egg"}]}] store result score ShieldbusterQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:cave_spider_spawn_egg"}]}] store result score CustomQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:snowball"}]}] store result score ShieldQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:arrow"}]}] store result score ArrowsQueue m.Variables run scoreboard players get QueueSize m.Variables
...
execute if entity @e[type=armor_stand,x=0,tag=m.QueueLooter,nbt={HandItems:[{id:"minecraft:firework_rocket"}]}] store result score FireballQueue m.Variables run scoreboard players get QueueSize m.Variables
