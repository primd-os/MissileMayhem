...
setblock -4 102 1 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"2 Teams"}',Text2:'{"text":"Game 1","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 1"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game1 run function missilewars:start/join_auto"}}'}
setblock -4 102 0 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"2 Teams"}',Text2:'{"text":"Game 2","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 2"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game2 run function missilewars:start/join_auto"}}'}
setblock -4 102 -1 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"2 Teams"}',Text2:'{"text":"Game 3","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 3"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game3 run function missilewars:start/join_auto"}}'}
setblock -4 101 1 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"4 Teams"}',Text2:'{"text":"Game 1","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 41"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game41 run function missilewars:start/join_auto4"}}'}
setblock -4 101 0 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"4 Teams"}',Text2:'{"text":"Game 2","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 42"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game42 run function missilewars:start/join_auto4"}}'}
setblock -4 101 -1 minecraft:oak_wall_sign[facing=east]{Text1:'{"text":"4 Teams"}',Text2:'{"text":"Game 3","clickEvent":{"action":"run_command","value":"scoreboard players set @s Game 43"}}',Text3:'{"text":"Click to Join","clickEvent":{"action":"run_command","value":"execute in missilewars:game43 run function missilewars:start/join_auto4"}}'}
