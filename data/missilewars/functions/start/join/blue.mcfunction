...
item replace entity @s armor.feet with leather_boots{display:{color:4607}, Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s},{id:"minecraft:feather_falling",lvl:9s}]} 1
